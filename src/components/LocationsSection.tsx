        ...
        >
          ...
          <div>
            ...
            >
              ...
              <p style={{ color: '#475067', fontSize: '15px', lineHeight: 1.6, marginBottom: '14px', fontFamily: 'var(--font-body)' }}>
                San Francisco, CA 94111
              </p>

              <p style={{ color: '#121212', fontSize: '15px', fontWeight: 600, fontFamily: 'var(--font-heading)' }}>
                +1 (800) 288-9659
              </p>
